...
OUT_PREFIX = "indices_5_8_9_11_19_best_22_24_26_27_28_glycerol095"
...
# Glycerol model with r_max close to 0.95
A_GLY = 0.633617
B_GLY = 0.831926
C_GLY = 0.241089
...
def plot_joint_xy(xy: np.ndarray, n_recordings: int) -> None:
    ...
    ax.set_title(
        ...
        "5, 8, 9, 11, 19, best, 22, 24, 26, 27, 28"
...
def plot_theta_distribution(r: np.ndarray, n_recordings: int) -> dict[str, float | int]:
    ...
    ax.set_title(
        ...
        "5, 8, 9, 11, 19, best, 22, 24, 26, 27, 28 | glycerol theta(r)"
        f" | n={n_recordings}"
    )
    ax.grid(True, alpha=0.25)
