...
recs = [
    ("sound_off", base / "rod_x1463_y1349_20260722-124216_1784720536014996900"),
    ("sound_on", base / "rod_x1463_y1349_20260722-124227_1784720547648684800"),
]
out = base / "sound_off_vs_on_20260722-124216_124227_analysis"
...
summary={'assumption':'Two newest folders used; earlier labelled sound_off and later labelled sound_on.', 'recordings':[{'label':l,'path':str(r),'fps':t['fps'],'n_frames':t['n_frames'],'duration_s':t['duration_s']} for l,r,t in data], 'intensity_stats':rows,'spectrum_checks':spec_rows,'output_dir':str(out)}
